...
class Cparser(object):
    ...
    def p_math_expression(self, p):
        """expression : expression '+' expression
                      ...
                      | expression '%' expression
                      | expression '^' expression"""
        p[0] = AST.MathExpression(p[1], p[2], p[3])
        p[1].setParent(p[0])
        p[3].setParent(p[0])
